    ...
    <div className="flex items-center justify-between h-16 lg:h-20">
      ...
      <div className="hidden lg:flex items-center">
        <a href="/brochure.pdf" download>
          <Button
            variant="default"
            className="text-white bg-gradient-to-r from-primary to-accent hover:shadow-elegant transition-all duration-300"
          >
            Download Brochure
          </Button>
        </a>
      ...
      <div className="lg:hidden py-4 animate-fade-in">
        <nav className="flex flex-col space-y-4">
          ...
          <a href="/brochure.pdf" download>
            <Button 
              variant="default"
              className="text-white hover:shadow-elegant transition-all duration-300 mt-4 w-fit"
            >
              Download Brochure
            </Button>
          </a>
